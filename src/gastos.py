...
class Gastos(QWidget):
	def __init__(self, mainWindows):
		QWidget.__init__(self)
		uic.loadUi(directory + "/../ui/clientes.ui", self)
		self.mainWindows = mainWindows
		mainWindows.diconnectActions()
		mainWindows.aNuevo.triggered.connect(mainWindows.nuevoGasto)
		self.mainWindows.setWindowTitle("Gastos | Arroyo v" + mainWindows.version)
	...
	def editItem(self):
		self.mainWindows.editarGasto(self.itemSelected)

	def viewItem(self):
		self.mainWindows.verGasto(self.itemSelected)
